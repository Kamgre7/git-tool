...
describe('Post commit schema', () => {
  ...
  describe('Body schema', () => {
    ...
    it('Should return false if commitMsg is not string or is empty', () => {
      body.commitMsg = null;
    ...
    it('Should return false if repo is not string or is empty', () => {
      body.repo = null;
    ...
    it('Should return false if owner is not string or is empty', () => {
      body.owner = null;
    ...
    it('Should return false if branch is not string or is empty', () => {
      body.branch = null;
    ...
    it('Should return true if path is not string, can be empty', () => {
      body.path = '';
